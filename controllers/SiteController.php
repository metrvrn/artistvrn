...
class SiteController extends Controller
{
    ...
    public function actionAbout()
    {
		...
		$model->fillAboutDataFromLocalFile();
        ...
        return $this->render('about',['catalogModel' => $catalogModel,'model'=>$model]);
    }
	    ...
	    public function actionDelivery()
    {
		...
		$model->fillDeliveryDataFromLocalFile();
        ...
        return $this->render('delivery',['catalogModel' => $catalogModel,'model'=>$model]);
    }
